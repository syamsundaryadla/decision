        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <motion.div 
              ...
              exit={{ opacity: 0, y: -10 }}
              className="lg:hidden absolute top-full left-0 right-0 border-b border-border/50 bg-background/60 backdrop-blur-3xl p-6 flex flex-col gap-6 shadow-2xl z-40"
            >
